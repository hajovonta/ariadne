    ...
    (t (let ((op (first expr))
         ...
         (cond
           ...
           ((sym-name-equal op "CONCAT")
            (apply #'concatenate 'string (mapcar (lambda (a) (princ-to-string (lit-val a))) args)))
           ...
           ((sym-name-equal op "ABS") (abs (lit-val (first args))))
           ((sym-name-equal op "ROUND") (round (lit-val (first args))))
           ((sym-name-equal op "CEIL") (ceiling (lit-val (first args))))
           ((sym-name-equal op "FLOOR") (floor (lit-val (first args))))
